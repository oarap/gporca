...
//
//---------------------------------------------------------------------------
CParseHandlerSubqueryScan::CParseHandlerSubqueryScan(IMemoryPool *memory_pool,
...
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalSubqueryScan),
									  element_local_name))
	{
	...
	m_dxl_op = (CDXLPhysicalSubqueryScan *) CDXLOperatorFactory::MakeDXLSubqScan(
