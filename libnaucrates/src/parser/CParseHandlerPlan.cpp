								...
								const Attributes &attrs)
{
	...
	// parse plan id
	const XMLCh *xml_str_plan_id =
		CDXLOperatorFactory::ExtractAttrValue(attrs, EdxltokenPlanId, EdxltokenPlan);
	m_plan_id =
		CDXLOperatorFactory::ConvertAttrValueToUllong(m_parse_handler_mgr->GetDXLMemoryManager(),
													  xml_str_plan_id,
													  EdxltokenPlanId,
													  EdxltokenPlan);

	// parse plan space size
	const XMLCh *xmlszPlanSpaceSize =
		CDXLOperatorFactory::ExtractAttrValue(attrs, EdxltokenPlanSpaceSize, EdxltokenPlan);
	m_plan_space_size =
		CDXLOperatorFactory::ConvertAttrValueToUllong(m_parse_handler_mgr->GetDXLMemoryManager(),
													  xmlszPlanSpaceSize,
