...
//
//---------------------------------------------------------------------------
CParseHandlerHashJoin::CParseHandlerHashJoin(IMemoryPool *memory_pool,
...
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalHashJoin),
									  element_local_name))
	{
	...
	CParseHandlerBase *hashjoin_filter_parse_handler = CParseHandlerFactory::GetParseHandler(
