...
//
//---------------------------------------------------------------------------
CParseHandlerScalarNullTest::CParseHandlerScalarNullTest(IMemoryPool *memory_pool,
...
{
	if ((0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarIsNull),
									   element_local_name)) ||
		(0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarIsNotNull),
									   element_local_name)))
	{
		if (NULL != m_dxl_node)
		{
		...
		if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenScalarIsNotNull),
										  element_local_name))
		{
			is_null = false;
		}
		...
		CDXLScalarNullTest *dxl_op = (CDXLScalarNullTest *) CDXLOperatorFactory::MakeDXLNullTest(
