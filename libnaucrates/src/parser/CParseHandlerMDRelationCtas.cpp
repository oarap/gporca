...
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenRelationCTAS),
									  element_local_name))
	{
	...
	// parse storage type
	const XMLCh *xml_str_storage_type =
	...
	const XMLCh *vartypemod_xml =
		CDXLOperatorFactory::ExtractAttrValue(attrs, EdxltokenVarTypeModList, EdxltokenRelation);
	m_vartypemod_array =
