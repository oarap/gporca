...
//
//---------------------------------------------------------------------------
CParseHandlerBroadcastMotion::CParseHandlerBroadcastMotion(IMemoryPool *memory_pool,
...
//---------------------------------------------------------------------------
void
CParseHandlerBroadcastMotion::StartElement(const XMLCh *const,  // element_uri,
										   const XMLCh *const element_local_name,
										   const XMLCh *const,  // element_qname
										   const Attributes &attrs)
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalBroadcastMotion),
									  element_local_name))
	{
	...
	m_dxl_op = (CDXLPhysicalBroadcastMotion *) CDXLOperatorFactory::MakeDXLBroadcastMotion(
