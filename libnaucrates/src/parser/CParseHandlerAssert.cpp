...
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalAssert),
									  element_local_name))
	{
	...
	CHAR *error_code =
		CDXLOperatorFactory::ExtractConvertAttrValueToSz(m_parse_handler_mgr->GetDXLMemoryManager(),
														 attrs,
														 EdxltokenErrorCode,
