...
//
//---------------------------------------------------------------------------
CParseHandlerRandomMotion::CParseHandlerRandomMotion(IMemoryPool *memory_pool,
...
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalRandomMotion),
									  element_local_name))
	{
	...
	m_dxl_op = (CDXLPhysicalRandomMotion *) CDXLOperatorFactory::MakeDXLRandomMotion(
