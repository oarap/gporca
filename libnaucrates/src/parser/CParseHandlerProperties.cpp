...
{
	if (0 ==
		XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenProperties), element_local_name))
	{
	...
	else if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenStatsDerivedRelation),
										   element_local_name))
	{
