...
//---------------------------------------------------------------------------
void
CParseHandlerIndexScan::StartElementHelper(const XMLCh *const element_local_name,
										   const Attributes &attrs,
										   Edxltoken token_type)
{
	...
	const XMLCh *index_scan_direction =
		CDXLOperatorFactory::ExtractAttrValue(attrs, EdxltokenIndexScanDirection, token_type);
