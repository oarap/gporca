...
//---------------------------------------------------------------------------
void
CParseHandlerRedistributeMotion::StartElement(const XMLCh *const,  // element_uri,
											  const XMLCh *const element_local_name,
											  const XMLCh *const,  // element_qname
											  const Attributes &attrs)
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalRedistributeMotion),
									  element_local_name))
	{
	...
	m_dxl_op = (CDXLPhysicalRedistributeMotion *) CDXLOperatorFactory::MakeDXLRedistributeMotion(
...
//---------------------------------------------------------------------------
void
CParseHandlerRedistributeMotion::EndElement(const XMLCh *const,  // element_uri,
											const XMLCh *const element_local_name,
											const XMLCh *const  // element_qname
)
{
