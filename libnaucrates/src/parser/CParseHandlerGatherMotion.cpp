...
//
//---------------------------------------------------------------------------
CParseHandlerGatherMotion::CParseHandlerGatherMotion(IMemoryPool *memory_pool,
...
{
	if (0 != XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenPhysicalGatherMotion),
									  element_local_name))
	{
	...
	m_dxl_op = (CDXLPhysicalGatherMotion *) CDXLOperatorFactory::MakeDXLGatherMotion(
