...
{
	if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOp),
									  element_local_name))
	{
		// parse operator name
		const XMLCh *xml_str_op_name =
			CDXLOperatorFactory::ExtractAttrValue(attrs, EdxltokenName, EdxltokenGPDBScalarOp);

		CWStringDynamic *str_opname = CDXLUtils::CreateDynamicStringFromXMLChArray(
		...
		const XMLCh *xml_str_returns_null_on_null_input =
			attrs.getValue(CDXLTokens::XmlstrToken(EdxltokenReturnsNullOnNullInput));
	...
	else if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpLeftTypeId),
										   element_local_name))
	{
		...
		m_mdid_type_left = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(
			...
			EdxltokenGPDBScalarOpLeftTypeId);
			 ...
			 XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpRightTypeId),
									  element_local_name))
	{
		...
		m_mdid_type_right = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(
			...
			EdxltokenGPDBScalarOpRightTypeId);
			 ...
			 XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpResultTypeId),
									  element_local_name))
	{
		// parse result type
		GPOS_ASSERT(NULL != m_mdname);
	...
	else if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpFuncId),
										   element_local_name))
	{
		// parse op func id
		GPOS_ASSERT(NULL != m_mdname);
	...
	else if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpCommOpId),
										   element_local_name))
	{
		...
		m_mdid_commute_opr = CDXLOperatorFactory::ExtractConvertAttrValueToMdId(
			...
			EdxltokenGPDBScalarOpCommOpId);
			 ...
			 XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpInverseOpId),
									  element_local_name))
	{
	...
	else if (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenOpClasses),
										   element_local_name))
	{
...
{
	return (0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpLeftTypeId),
										  xml_str) ||
			0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpRightTypeId),
										  xml_str) ||
			0 == XMLString::compareString(
					 CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpResultTypeId), xml_str) ||
			0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpFuncId),
										  xml_str) ||
			0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpCommOpId),
										  xml_str) ||
			0 == XMLString::compareString(CDXLTokens::XmlstrToken(EdxltokenGPDBScalarOpInverseOpId),
										  xml_str));
}
