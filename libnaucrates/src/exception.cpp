	...
	)
{
	...
	CMessage rgmsg[ExmiDXLSentinel] =
	{
			...
			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLUnexpectedTag),
					 ...
					 GPOS_WSZ_WSZLEN("Unexpected tag: %ls"),
					 1, // elemname
			...
			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLUnrecognizedCompOperator),
					 CException::ExsevError,
					 GPOS_WSZ_WSZLEN("Unrecognized comparison operator"),
					 1, // comp op
					 GPOS_WSZ_WSZLEN("Unrecognized comparison operator")),

			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLValidationError),
					 CException::ExsevError,
					 GPOS_WSZ_WSZLEN("XML validation exception: XML document does not conform to the DXL schema. Details: %s"),
					 1, // exception details
			...
			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXLIncorrectNumberOfChildren),
					 CException::ExsevError,
					 GPOS_WSZ_WSZLEN("Incorrect Number of children"),
					 0, //
					 GPOS_WSZ_WSZLEN("Incorrect Number of children")),

			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiPlStmt2DXLConversion),
					 CException::ExsevError,
			...
			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXL2PlStmtExternalScanError),
					CException::ExsevError,
				 	GPOS_WSZ_WSZLEN("External scan error: %ls"),
					1, //
					GPOS_WSZ_WSZLEN("External scan error")),

			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLAttributeNotFound),
					CException::ExsevError,
					GPOS_WSZ_WSZLEN("Query-to-DXL Translation: Attribute number %d not found in project list"),
					1, //
					GPOS_WSZ_WSZLEN("Query-to-DXL Translation: Attribute number not found in project list")),
			...
			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLDuplicateRTE),
					CException::ExsevError,
					GPOS_WSZ_WSZLEN("DXL-to-Query: Duplicate range table entry at query level %d at position %d"),
					2, // query level and var no
					GPOS_WSZ_WSZLEN("DXL-to-Query: Duplicate range table entry")),
					 
			// MD related messages
			CMessage(CException(gpdxl::ExmaMD, gpdxl::ExmiMDCacheEntryDuplicate),
					 CException::ExsevError,
					 GPOS_WSZ_WSZLEN("Entry for metadata cache object %ls already exists"),
					 1, // mdid
			...
			CMessage(CException(gpdxl::ExmaGPDB, gpdxl::ExmiGPDBError),
					 CException::ExsevError,
					 GPOS_WSZ_WSZLEN("PG exception raised"),
					 1, // type
					 GPOS_WSZ_WSZLEN("PG exception converted to GPOS exception")),

			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiQuery2DXLError),
					CException::ExsevError,
					GPOS_WSZ_WSZLEN("Query-to-DXL Translation: %ls entry found due to incorrect normalization of query"),
					1, // entry name
					GPOS_WSZ_WSZLEN("Query-to-DXL Translation: Entry not found due to incorrect normalization of query")),
			...
			CMessage(CException(gpdxl::ExmaConstExprEval, gpdxl::ExmiConstExprEvalNonConst),
					 CException::ExsevError,
					 GPOS_WSZ_WSZLEN("Illegal column reference \"%ls\" in constant expression"),
					 1, // column name
					 GPOS_WSZ_WSZLEN("Illegal column reference \"%ls\" in constant expression")),
				 
			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiExpr2DXLAttributeNotFound),
					CException::ExsevError,
					GPOS_WSZ_WSZLEN("Expr-to-DXL Translation: Attribute number %d not found in project list"),
					1, // attno
					GPOS_WSZ_WSZLEN("Expr-to-DXL Translation: Attribute number not found in project list")),

			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXL2PlStmtAttributeNotFound),
					CException::ExsevError,
					GPOS_WSZ_WSZLEN("DXL-to-PlStmt Translation: Attribute number %d not found in project list"),
					1, // attno
					GPOS_WSZ_WSZLEN("DXL-to-PlStmt Translation: Attribute number not found in project list")),

			CMessage(CException(gpdxl::ExmaDXL, gpdxl::ExmiDXL2ExprAttributeNotFound),
					CException::ExsevError,
