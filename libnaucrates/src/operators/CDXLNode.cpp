...
//
//---------------------------------------------------------------------------
CDXLNode::CDXLNode(IMemoryPool *memory_pool)
	: m_memory_pool(memory_pool),
	  m_dxl_op(NULL),
	  m_dxl_properties(NULL),
	  m_direct_dispatch_info(NULL)
{
	m_dxl_array = GPOS_NEW(memory_pool) DXLNodeArray(memory_pool);
}
...
//
//---------------------------------------------------------------------------
CDXLNode::CDXLNode(IMemoryPool *memory_pool, CDXLOperator *dxl_op)
	: m_memory_pool(memory_pool),
	  m_dxl_op(dxl_op),
	  m_dxl_properties(NULL),
	  m_direct_dispatch_info(NULL)
...
//
//---------------------------------------------------------------------------
CDXLNode::CDXLNode(IMemoryPool *memory_pool, CDXLOperator *dxl_op, CDXLNode *child_dxlnode)
	: m_memory_pool(memory_pool),
	  m_dxl_op(dxl_op),
	  m_dxl_properties(NULL),
	  m_dxl_array(NULL),
...
{
	GPOS_ASSERT(NULL != dxl_op);
	GPOS_ASSERT(NULL != first_child_dxlnode);
	GPOS_ASSERT(NULL != second_child_dxlnode);
	  ...
	  m_direct_dispatch_info(NULL)
{
	...
	GPOS_ASSERT(NULL != first_child_dxlnode);
	GPOS_ASSERT(NULL != second_child_dxlnode);
	GPOS_ASSERT(NULL != third_child_dxlnode);
...
//
//---------------------------------------------------------------------------
CDXLNode::CDXLNode(IMemoryPool *memory_pool, CDXLOperator *dxl_op, DXLNodeArray *dxl_array)
	: m_memory_pool(memory_pool),
	  m_dxl_op(dxl_op),
	  m_dxl_properties(NULL),
...
//---------------------------------------------------------------------------
void
CDXLNode::SetDirectDispatchInfo(CDXLDirectDispatchInfo *dxl_direct_dispatch_info)
{
	// allow setting direct dispatch info only once
	GPOS_ASSERT(NULL == m_direct_dispatch_info);
