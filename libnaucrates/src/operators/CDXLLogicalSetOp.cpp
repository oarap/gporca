...
//---------------------------------------------------------------------------
void
CDXLLogicalSetOp::SerializeToDXL(CXMLSerializer *xml_serializer, const CDXLNode *node) const
{
	...
	xml_serializer->AddAttribute(CDXLTokens::GetDXLTokenStr(EdxltokenCastAcrossInputs),
...
//---------------------------------------------------------------------------
void
CDXLLogicalSetOp::AssertValid(const CDXLNode *node, BOOL validate_children) const
{
