...
//
//---------------------------------------------------------------------------
CDXLDatumInt4::CDXLDatumInt4(IMemoryPool *memory_pool, IMDId *mdid_type, BOOL is_null, INT val)
	: CDXLDatum(memory_pool, mdid_type, default_type_modifier, is_null, 4 /*length*/), m_val(val)
{
}
