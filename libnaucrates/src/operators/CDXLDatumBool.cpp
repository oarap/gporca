...
//
//---------------------------------------------------------------------------
CDXLDatumBool::CDXLDatumBool(IMemoryPool *memory_pool, IMDId *mdid_type, BOOL is_null, BOOL value)
	: CDXLDatum(memory_pool, mdid_type, default_type_modifier, is_null, 1 /*length*/),
	  m_value(value)
{
}
