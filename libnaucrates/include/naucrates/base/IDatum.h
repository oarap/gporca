...
namespace gpnaucrates
{
	...
	class IDatum: public CRefCount
	{
		...
		public:
			...
			virtual
			const CWStringConst *GetStrRepr(IMemoryPool *memory_pool) const = 0;
			...
			virtual
			IDatum *MakeCopy(IMemoryPool *memory_pool) const = 0;
			...
			virtual
			IDatum *MakePaddedDatum(IMemoryPool *memory_pool, ULONG col_len) const = 0;
