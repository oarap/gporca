...
namespace gpdxl
{
	...
	class CDXLOperatorFactory
	{
		...
		public:
			...
			static
			EdxlJoinType ParseJoinType(const XMLCh *xmlszJoinType, const CWStringConst *join_name);
			...
			static
			IMDRelation::Ereldistrpolicy ParseRelationDistPolicy(const XMLCh *xml_val);
