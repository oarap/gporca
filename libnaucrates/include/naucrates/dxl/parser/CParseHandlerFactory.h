...
namespace gpdxl
{
	...
	typedef CParseHandlerBase *(ParseHandlerOpCreatorFunc)(IMemoryPool *mp,
	...
	private:
		...
		static CParseHandlerBase *CreatePlanParseHandler(IMemoryPool *mp,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateCTECfgParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateHintParseHandler(IMemoryPool *mp,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDIndexParseHandler(IMemoryPool *mp,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDTypeParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDFuncParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);

		// construct an MD aggregate operation parse handler
		static CParseHandlerBase *CreateMDAggParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDCastParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);

		// construct an MD scalar comparison parse handler
		static CParseHandlerBase *CreateMDScCmpParseHandler(IMemoryPool *mp,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDColsParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDColParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateFilterParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateResultParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateNLJoinParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateSortParseHandler(IMemoryPool *mp,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);

		// construct an append parse handler
		static CParseHandlerBase *CreateAppendParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateDTSParseHandler(IMemoryPool *mp,
														CParseHandlerManager *parse_handler_mgr,
														CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateLimitParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScArrayParseHandler(IMemoryPool *mp,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateAggParseHandler(IMemoryPool *mp,
														CParseHandlerManager *parse_handler_mgr,
														CParseHandlerBase *parse_handler_root);

		// construct an aggregate function parse handler
		static CParseHandlerBase *CreateAggRefParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);

		// construct a parse handler for a physical window node
		static CParseHandlerBase *CreateWindowParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScCmpParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScIdParseHandler(IMemoryPool *mp,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScCastParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateIfStmtParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateSortColParseHandler(IMemoryPool *mp,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);

		// construct a cost parse handler
		static CParseHandlerBase *CreateCostParseHandler(IMemoryPool *mp,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateColDescParseHandler(IMemoryPool *mp,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateQueryParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateCTEListParseHandler(IMemoryPool *mp,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateStatsParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateXformParseHandler(IMemoryPool *mp,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScExprParseHandler(IMemoryPool *mp,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
