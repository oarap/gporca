...
namespace gpdxl
{
	...
	typedef CParseHandlerBase *(ParseHandlerOpCreatorFunc)(IMemoryPool *memory_pool,
	...
	{
		typedef CHashMap<const XMLCh,
						 ParseHandlerOpCreatorFunc,
						 GetHashXMLStr,
						 IsXMLStrEqual,
						 CleanupNULL,
						 CleanupNULL>
	...
	private:
		...
		static CParseHandlerBase *CreatePlanParseHandler(IMemoryPool *memory_pool,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateCTECfgParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateHintParseHandler(IMemoryPool *memory_pool,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDIndexParseHandler(IMemoryPool *memory_pool,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDTypeParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDFuncParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);

		// construct an MD aggregate operation parse handler
		static CParseHandlerBase *CreateMDAggParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDCastParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);

		// construct an MD scalar comparison parse handler
		static CParseHandlerBase *CreateMDScCmpParseHandler(IMemoryPool *memory_pool,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDColsParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateMDColParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateFilterParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateResultParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateNLJoinParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateSortParseHandler(IMemoryPool *memory_pool,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);

		// construct an append parse handler
		static CParseHandlerBase *CreateAppendParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateDTSParseHandler(IMemoryPool *memory_pool,
														CParseHandlerManager *parse_handler_mgr,
														CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateLimitParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScArrayParseHandler(IMemoryPool *memory_pool,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateAggParseHandler(IMemoryPool *memory_pool,
														CParseHandlerManager *parse_handler_mgr,
														CParseHandlerBase *parse_handler_root);

		// construct an aggregate function parse handler
		static CParseHandlerBase *CreateAggRefParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);

		// construct a parse handler for a physical window node
		static CParseHandlerBase *CreateWindowParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScCmpParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScIdParseHandler(IMemoryPool *memory_pool,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScCastParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateIfStmtParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateSortColParseHandler(IMemoryPool *memory_pool,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);

		// construct a cost parse handler
		static CParseHandlerBase *CreateCostParseHandler(IMemoryPool *memory_pool,
														 CParseHandlerManager *parse_handler_mgr,
														 CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateColDescParseHandler(IMemoryPool *memory_pool,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateQueryParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateCTEListParseHandler(IMemoryPool *memory_pool,
															CParseHandlerManager *parse_handler_mgr,
															CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateStatsParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateXformParseHandler(IMemoryPool *memory_pool,
														  CParseHandlerManager *parse_handler_mgr,
														  CParseHandlerBase *parse_handler_root);
		...
		static CParseHandlerBase *CreateScExprParseHandler(IMemoryPool *memory_pool,
														   CParseHandlerManager *parse_handler_mgr,
														   CParseHandlerBase *parse_handler_root);
	...
	public:
		...
		static CParseHandlerBase *GetParseHandler(IMemoryPool *memory_pool,
												  const XMLCh *xml_str,
												  CParseHandlerManager *parse_handler_mgr,
												  CParseHandlerBase *parse_handler_root);

		// factory methods for creating parse handlers
		static CParseHandlerDXL *GetParseHandlerDXL(IMemoryPool *memory_pool,
													CParseHandlerManager *);
	};
}  // namespace gpdxl
