...
namespace gpopt
{
	...
	class CSubqueryTestUtils
	{
		...
		public:
			...
			static
			CExpression *PexprSubqueryQuantified(IMemoryPool *memory_pool, COperator::EOperatorId op_id, CExpression *pexprOuter, CExpression *pexprInner, BOOL fCorrelated);

			// generate quantified subquery expression over window operations
			static
			CExpression *PexprSelectWithSubqueryQuantifiedOverWindow(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate existential subquery expression
			static
			CExpression *PexprSubqueryExistential(IMemoryPool *memory_pool, COperator::EOperatorId op_id, CExpression *pexprOuter, CExpression *pexprInner, BOOL fCorrelated);
			...
			static
			CExpression *PexprSelectWithNestedQuantifiedSubqueries(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate randomized quantified subquery expression
			static
			CExpression *PexprSelectWithSubqueryQuantified(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate randomized quantified subquery expression whose inner expression is a Gb
			static
			CExpression *PexprSelectWithQuantifiedAggSubquery(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate randomized Project expression with quantified subquery
			static
			CExpression *PexprProjectWithSubqueryQuantified(IMemoryPool *memory_pool, CExpression *pexprOuter, CExpression *pexprInner, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate randomized Select with existential subquery expression
			static
			CExpression *PexprSelectWithSubqueryExistential(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate randomized Select expression with existential subquery predicate that can be trimmed
			static
			CExpression *PexprSelectWithTrimmableExistentialSubquery(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);

			// generate randomized Project with existential subquery expression
			static
			CExpression *PexprProjectWithSubqueryExistential(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);
			...
			static
			CExpression *PexprSubqueryWithConstTableGet(IMemoryPool *memory_pool, COperator::EOperatorId op_id);
			...
			static
			CExpression *PexprUndecorrelatableSubquery(IMemoryPool *memory_pool, COperator::EOperatorId op_id, BOOL fCorrelated);
