...
{
	DrgPcr *colref_array = CUtils::PdrgpcrRemap(memory_pool, Pdrgpcr(), colref_mapping, must_exist);
	...
	DrgPcr *pdrgpcrKeys = CUtils::PdrgpcrRemap(memory_pool, m_pdrgpcrKeys, colref_mapping, must_exist);
