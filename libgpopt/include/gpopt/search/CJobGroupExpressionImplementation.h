...
namespace gpopt
{
	...
	class CJobGroupExpressionImplementation : public CJobGroupExpression
	{
		...
		private:
			...
			static
			EEvent EevtImplementSelf(CSchedulerContext *psc, CJob *pj);
			...
			// private copy ctor
			CJobGroupExpressionImplementation(const CJobGroupExpressionImplementation&);
		...
		public:
			...
			// conversion function
			static
			CJobGroupExpressionImplementation *PjConvert
				(
				CJob *pj
				)
			{
...
#endif // !GPOPT_CJobGroupExpressionImplementation_H
