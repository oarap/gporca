...
namespace gpopt
{
	...
	class CWindowFrame : public CRefCount
	{
		...
		public:
			...
			// specification
			EFrameSpec Efs() const
			{
				return m_efs;
			}

			// type of leading edge
			EFrameBoundary EfbLeading() const
			{
				return m_efbLeading;
			}

			// type of trailing edge
			EFrameBoundary EfbTrailing() const
			{
			...
			// exclusion strategy
			EFrameExclusionStrategy Efes() const
			{
				return m_efes;
			}
