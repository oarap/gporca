...
namespace gpopt
{
	...
	class CCastUtils
	{
		public:
			...
			static
			CExpression *PexprCast( IMemoryPool *memory_pool, CMDAccessor *md_accessor, const CColRef *colref, IMDId *mdid_dest);
            ...
            static
            CExpression *PexprAddCast(IMemoryPool *memory_pool, CExpression *pexprPred);
