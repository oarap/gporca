...
namespace gpopt
{
	...
	class CEnfdPartitionPropagation : public CEnfdProp
	{
		...
		public:
			...
			// ctor
			CEnfdPartitionPropagation(CPartitionPropagationSpec *ppps, EPartitionPropagationMatching eppm, CPartFilterMap *ppfm);
			...
			EPartitionPropagationMatching Eppm() const
			{
				return m_eppm;
			}
			...
			static 
			const CHAR *SzPropagationMatching(EPartitionPropagationMatching eppm);
