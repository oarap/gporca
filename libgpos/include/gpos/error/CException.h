...
namespace gpos
{
	...
	public:
		...
		CException(
			ULONG major, ULONG minor, const CHAR *filename, ULONG line, ULONG severity_level);
		...
		static void Raise(const CHAR *filename, ULONG line, ULONG major, ULONG minor, ...)
			__attribute__((__noreturn__));

		// wrapper around throw with severity level
		static void Raise(
			const CHAR *filename, ULONG line, ULONG major, ULONG minor, ULONG severity_level, ...)
			__attribute__((__noreturn__));
